      ...
      <section className="flex flex-col md:flex-row items-start gap-12 pt-12">
        <div className="flex-1 space-y-10">
          ...
          <p className="text-2xl md:text-3xl font-bold leading-tight max-w-3xl text-gray-800">
            AI Engineer and Researcher dedicated to solving complex real-world challenges through NLP and Large Language Models. Leveraging a unique intersection of linguistic foundations and advanced AI research, I focus on building next-generation intelligent systems that are robust, efficient, and impactful.
          </p>
        ...
        <section className="md:col-span-4 bg-blue-400 border-4 border-black p-8 neo-brutal-shadow flex flex-col gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-white border-2 border-black p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              <h3 className="text-xl font-black italic underline decoration-purple-500 underline-offset-4">MSc. Artificial Intelligence</h3>
              <p className="font-bold text-lg mt-1">University Of Essex • Jan 2025 to Present</p>
            </div>
            <div className="bg-white border-2 border-black p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              <h3 className="text-xl font-black italic underline decoration-purple-500 underline-offset-4">B.A. Modern Languages</h3>
              <p className="font-bold text-lg mt-1">University of Birmingham • Sept 2016 - Sept 2020</p>
